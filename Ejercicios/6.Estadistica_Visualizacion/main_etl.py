...
#df_ventas['fecha_venta'] = df_ventas['fecha_venta'].apply(pd.to_datetime).astype('datetime64[ns]')
#no nulos
...
print(df_ventas['fecha_venta'].dtype)

lista_tuplas_ventas = [tuple (fila) for fila in 
df_ventas.values]
